...
import { arcido_flow_services, arcido_studio_services } from "@/types/static-data";
...
export default function Page() {
  return (
    ...
    text-center lg:text-left"
        >
          We provide seamless packaging solutions and logistics integrations for{" "}
          <span className="text-[#72B6FF]">D2C </span> and{" "}
          <span className="text-[#72B6FF]">E-Commerce Brands</span>.
        </p>
