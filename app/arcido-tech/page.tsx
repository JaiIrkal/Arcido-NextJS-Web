...
import { arcido_tech_services } from "@/types/static-data";
  ...
  return (
    ...
    text-center lg:text-left"
        >
          ...
          <span className="text-[#72B6FF]">robust infrastructure</span> and
          <br className="hidden sm:block" />
          <span className="text-[#72B6FF]">secure integrations</span>.
        </p>
