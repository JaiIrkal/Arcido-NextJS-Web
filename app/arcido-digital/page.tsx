...
import { arcido_digital_services, arcido_flow_services, arcido_studio_services } from "@/types/static-data";
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-transparent text-white text-center">
      <section className="mt-8 flex justify-center">
        <img src="/images/subsidary-icons/landscape/arcido-digital-logo.png"
    ...
    "
        />
  <img
    src="/images/subsidary-icons/arcido-digital-logo.png"
    alt="Arcido Digital Logo"
    className="
      w-[296px] h-[296px]
      sm:w-0 sm:h-0
    ...
    text-center lg:text-left"
      ...
      <section className="bg-black sm:px-12 py-20 sm:py-24 lg:py-32 text-center w-full">
        ...
        <div className="flex flex-col lg:flex-row justify-around items-center gap-12 mt-12 lg:mt-16">
          {arcido_digital_services.map((item) => (
            <div
              key={item.id}
